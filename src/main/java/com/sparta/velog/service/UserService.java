...
public class UserService {
    ...
    public UserResponseDto signUp(UserRequestDto userRequestDto) {
        ...
        return UserResponseDto.of(userRepository.save(UserEntity.of(userRequestDto, passwordEncoder)));
    }
    ...
    public TokenDto login(UserRequestDto userRequestDto) {
        ...
        UsernamePasswordAuthenticationToken authenticationToken = new UsernamePasswordAuthenticationToken(userRequestDto.getUsername(), userRequestDto.getPassword1());
        ...
        // 5. RefreshToken 저장
        RefreshToken refreshToken = RefreshToken.builder().key(userId).value(tokenDto.getRefreshToken()).build();
    ...
    public TokenDto logout() {
        ...
        var token = refreshTokenRepository.findById(userId).orElseThrow(() -> new RefreshTokenNotFoundException("userId: " + userId + "의 리프레쉬 토큰을 찾을 수 없습니다."));
    ...
    public TokenDto renewToken(TokenRequestDto tokenRequestDto) {
        ...
        RefreshToken savedRefreshToken = refreshTokenRepository.findById(userId).orElseThrow(() -> new RefreshTokenNotFoundException("로그아웃 된 사용자입니다."));
        ...
        RefreshToken newRefreshToken = savedRefreshToken.withValue(tokenDto.getRefreshToken());
